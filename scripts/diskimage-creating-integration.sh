...
sudo bash diskimage-create/diskimage-create.sh -p vanilla -i $image_type
...
SCALING_TEST=True
TRANSIENT_TEST=True
VANILLA_IMAGE=ci-${image_type}-${GERRIT_CHANGE_NUMBER}-hadoop_1.qcow2
VANILLA_TWO_IMAGE=ci-${image_type}-${GERRIT_CHANGE_NUMBER}-hadoop_2.qcow2
...
OS_PASSWORD = 'nova'
OS_TENANT_NAME = 'ci'
OS_TENANT_ID = '4db038ca8fb14bf98f10ae69e1cbed93'
OS_AUTH_URL = 'http://172.18.168.42:5000/v2.0'
SAVANNA_HOST = '$ADDR'
FLAVOR_ID = '20'
CLUSTER_CREATION_TIMEOUT = $TIMEOUT
CLUSTER_NAME = 'diskimage-$BUILD_NUMBER-$ZUUL_CHANGE-$ZUUL_PATCHSET'
