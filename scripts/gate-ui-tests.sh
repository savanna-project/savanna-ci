...
cd /home/ubuntu && screen -dmS savanna /bin/bash -c "savanna/bin/python savanna-venv/bin/savanna-api --config-file savanna/etc/savanna.conf -d --log-file /tmp/savanna.log"
